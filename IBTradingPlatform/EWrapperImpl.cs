...
namespace IBTradingPlatform
{
    ...
    //! [ewrapperimpl]
        ...
        public virtual void tickPrice(int tickerId, int field, double price, TickAttrib attribs) 
        {
            ...
            string strData = "Tick Price. Ticler Id: " + tickerId + ", Field: " + field + ", Price: " + price + ", CanAutoExecute: " + attribs.CanAutoExecute;

            string tickPrice = tickerId + ", " + field + ", " + price + ", " + attribs.CanAutoExecute;
            // Write strData to the console
            myForm.AddListBoxItemTickPrice(tickPrice);
        ...
        public virtual void tickSize(int tickerId, int field, decimal size)
        {
            ...
            string strData = "Tick string. Ticker Id:" + tickerId + ", Field: " + field + ", Size: " + size;
        ...
        public virtual void position(string account, Contract contract, decimal pos, double avgCost)
        {
            ...
            string strData = "Position: " + account + ", - Symbol: " + contract.Symbol + ", SecType: " + contract.SecType + ", Currency: " + contract.Currency +
                ", Position: " + Util.DecimalMaxString(pos) + ", Avg cost: " + Util.DoubleMaxString(avgCost);
